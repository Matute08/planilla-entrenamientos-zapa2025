            ...
            <div className="relative inline-block text-left">
                ...
                {dropdownOpen && (
                    <div className="absolute right-0 mt-2 w-48 bg-white border border-gray-200 rounded-md shadow-lg z-10">
                        <button
                            className="block w-full px-4 py-2 text-left text-black text-lg hover:bg-gray-300 focus:ring-offset-2 disabled:opacity-50 disabled:cursor-not-allowed focus:outline-none focus:ring-2 "
                            onClick={onAddPlayer}
